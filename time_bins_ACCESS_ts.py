"""
A routine to split ACCESS SST netCDF data into different files according to
...
f = n.Dataset('ACCESS_data/ts_Amon_ACCESS1-3_historical_r3i1p1_185001-200512.nc','r')
