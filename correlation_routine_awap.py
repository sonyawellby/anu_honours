...
def awapCorrENSO_data():
    annual = corr(awap_Annual,Nino34_annual,0)
    JJA = corr(awap_JJA,Nino34_JJA,0)
    SON = corr(awap_SON,Nino34_SON,0)
    DJF = corr(awap_DJF,Nino34_DJF,0)
    MAM = corr(awap_MAM,Nino34_MAM,0)
    Jun = corr(awap_June,Nino34_Jun,0)
    Jul = corr(awap_July,Nino34_Jul,0)
    Aug = corr(awap_August,Nino34_Aug,0)
    Sep = corr(awap_September,Nino34_Sep,0)
    Oct = corr(awap_October,Nino34_Oct,0)
    Nov = corr(awap_November,Nino34_Nov,0)
    Dec = corr(awap_December,Nino34_Dec,0)
    Jan = corr(awap_January,Nino34_Jan,0)
    Feb = corr(awap_February,Nino34_Feb,0)
    Mar = corr(awap_March,Nino34_Mar,0)
    Apr = corr(awap_April,Nino34_Apr,0)
    May = corr(awap_May,Nino34_May,0)
...
def awapCorrTPI_data():
    annual = corr(awap_Annual,TPI_annual,1)
    JJA = corr(awap_JJA,TPI_JJA,1)
    SON = corr(awap_SON,TPI_SON,1)
    DJF = corr(awap_DJF,TPI_DJF,1)
    MAM = corr(awap_MAM,TPI_MAM,1)
    Jun = corr(awap_June,TPI_Jun,1)
    Jul = corr(awap_July,TPI_Jul,1)
    Aug = corr(awap_August,TPI_Aug,1)
    Sep = corr(awap_September,TPI_Sep,1)
    Oct = corr(awap_October,TPI_Oct,1)
    Nov = corr(awap_November,TPI_Nov,1)
    Dec = corr(awap_December,TPI_Dec,1)
    Jan = corr(awap_January,TPI_Jan,1)
    Feb = corr(awap_February,TPI_Feb,1)
    Mar = corr(awap_March,TPI_Mar,1)
    Apr = corr(awap_April,TPI_Apr,1)
    May = corr(awap_May,TPI_May,1)
