"""
A routine to split ACCESS precipitation netCDF data into different files according to
...
f = n.Dataset('ACCESS_data/pr_Amon_ACCESS1-3_historical_r3i1p1_185001-200512.nc','r')
...
#Changes units of 'pr' variable (from mm/day to mm/month) so compatibile with AWAP dataset
#Note: prc_monthly[1871][160][40] is: timestep, latitude, longitude
prc_monthly = [m['pr'][i]*m['time'][i] for i in range(0,len(m['time']))]
m['pr'] = prc_monthly
