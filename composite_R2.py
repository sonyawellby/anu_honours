...
ACCESS_June = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/June/*.png",3,3,title=(r'ACCESS1.3 R2 June: mean rainfall (3 $\sigma$)'))
ACCESS_June_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/June/*.png",3,3,title=(r'ACCESS1.3 R2 June: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_July = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/July/*.png",3,3,title=(r'ACCESS1.3 R2 July: mean rainfall (3 $\sigma$)'))
ACCESS_July_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/July/*.png",3,3,title=(r'ACCESS1.3 R2 July: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_August = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/August/*.png",3,3,title=(r'ACCESS1.3 R2 August: mean rainfall (3 $\sigma$)'))
ACCESS_August_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/August/*.png",3,3,title=(r'ACCESS1.3 R2 August: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_September = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/September/*.png",3,3,title=(r'ACCESS1.3 R2 September: mean rainfall (3 $\sigma$)'))
ACCESS_September_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/September/*.png",3,3,title=(r'ACCESS1.3 R2 September: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_October = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/October/*.png",3,3,title=(r'ACCESS1.3 R2 October: mean rainfall (3 $\sigma$)'))
ACCESS_October_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/October/*.png",3,3,title=(r'ACCESS1.3 R2 October: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_November = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/November/*.png",3,3,title=(r'ACCESS1.3 R2 November: mean rainfall (3 $\sigma$)'))
ACCESS_November_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/November/*.png",3,3,title=(r'ACCESS1.3 R2 November: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_December = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/December/*.png",3,3,title=(r'ACCESS1.3 R2 December: mean rainfall (3 $\sigma$)'))
ACCESS_December_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/December/*.png",3,3,title=(r'ACCESS1.3 R2 December: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_January = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/January/*.png",3,3,title=(r'ACCESS1.3 R2 January: mean rainfall (3 $\sigma$)'))
ACCESS_January_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/January/*.png",3,3,title=(r'ACCESS1.3 R2 January: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_February = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/February/*.png",3,3,title=(r'ACCESS1.3 R2 February: mean rainfall (3 $\sigma$)'))
ACCESS_February_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/February/*.png",3,3,title=(r'ACCESS1.3 R2 February: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_March = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/March/*.png",3,3,title=(r'ACCESS1.3 R2 March: mean rainfall (3 $\sigma$)'))
ACCESS_March_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/March/*.png",3,3,title=(r'ACCESS1.3 R2 March: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_April = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/April/*.png",3,3,title=(r'ACCESS1.3 R2 April: mean rainfall (3 $\sigma$)'))
ACCESS_April_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/April/*.png",3,3,title=(r'ACCESS1.3 R2 April: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_May = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/May/*.png",3,3,title=(r'ACCESS1.3 R2 May: mean rainfall (3 $\sigma$)'))
ACCESS_May_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/May/*.png",3,3,title=(r'ACCESS1.3 R2 May: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_JJA = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/JJA/*.png",3,3,title=(r'ACCESS1.3 R2 JJA: mean rainfall (3 $\sigma$)'))
ACCESS_JJA_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/JJA/*.png",3,3,title=(r'ACCESS1.3 R2 JJA: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_SON = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/SON/*.png",3,3,title=(r'ACCESS1.3 R2 SON: mean rainfall (3 $\sigma$)'))
ACCESS_SON_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/SON/*.png",3,3,title=(r'ACCESS1.3 R2 SON: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_DJF = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/DJF/*.png",3,3,title=(r'ACCESS1.3 R2 DJF: mean rainfall (3 $\sigma$)'))
ACCESS_DJF_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/DJF/*.png",3,3,title=(r'ACCESS1.3 R2 DJF: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_MAM = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/MAM/*.png",3,3,title=(r'ACCESS1.3 R2 MAM: mean rainfall (3 $\sigma$)'))
ACCESS_MAM_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/MAM/*.png",3,3,title=(r'ACCESS1.3 R2 MAM: mean rainfall anomalies (3 $\sigma$)'))
...
ACCESS_annual = multi("my_coding_routines/images/composite/"+num+"/rainfall/R2/Annual/*.png",3,3,title=(r'ACCESS1.3 R2 annual: mean rainfall (3 $\sigma$)'))
ACCESS_annual_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R2/Annual/*.png",3,3,title=(r'ACCESS1.3 R2 annual: mean rainfall anomalies (3 $\sigma$)'))
