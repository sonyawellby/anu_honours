...
ACCESS_June = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/June/*.png",3,3,title=(r'ACCESS1.3 R3 June: mean rainfall'+sigma))
ACCESS_June_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/June/*.png",3,3,title=(r'ACCESS1.3 R3 June: mean rainfall anomalies'+sigma))
...
ACCESS_July = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/July/*.png",3,3,title=(r'ACCESS1.3 R3 July: mean rainfall'+sigma))
ACCESS_July_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/July/*.png",3,3,title=(r'ACCESS1.3 R3 July: mean rainfall anomalies'+sigma))
...
ACCESS_August = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/August/*.png",3,3,title=(r'ACCESS1.3 R3 August: mean rainfall'+sigma))
ACCESS_August_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/August/*.png",3,3,title=(r'ACCESS1.3 R3 August: mean rainfall anomalies'+sigma))
...
ACCESS_September = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/September/*.png",3,3,title=(r'ACCESS1.3 R3 September: mean rainfall'+sigma))
ACCESS_September_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/September/*.png",3,3,title=(r'ACCESS1.3 R3 September: mean rainfall anomalies'+sigma))
...
ACCESS_October = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/October/*.png",3,3,title=(r'ACCESS1.3 R3 October: mean rainfall'+sigma))
ACCESS_October_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/October/*.png",3,3,title=(r'ACCESS1.3 R3 October: mean rainfall anomalies'+sigma))
...
ACCESS_November = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/November/*.png",3,3,title=(r'ACCESS1.3 R3 November: mean rainfall'+sigma))
ACCESS_November_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/November/*.png",3,3,title=(r'ACCESS1.3 R3 November: mean rainfall anomalies'+sigma))
...
ACCESS_December = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/December/*.png",3,3,title=(r'ACCESS1.3 R3 December: mean rainfall'+sigma))
ACCESS_December_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/December/*.png",3,3,title=(r'ACCESS1.3 R3 December: mean rainfall anomalies'+sigma))
...
ACCESS_January = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/January/*.png",3,3,title=(r'ACCESS1.3 R3 January: mean rainfall'+sigma))
ACCESS_January_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/January/*.png",3,3,title=(r'ACCESS1.3 R3 January: mean rainfall anomalies'+sigma))
...
ACCESS_February = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/February/*.png",3,3,title=(r'ACCESS1.3 R3 February: mean rainfall'+sigma))
ACCESS_February_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/February/*.png",3,3,title=(r'ACCESS1.3 R3 February: mean rainfall anomalies'+sigma))
...
ACCESS_March = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/March/*.png",3,3,title=(r'ACCESS1.3 R3 March: mean rainfall'+sigma))
...
ACCESS_April = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/April/*.png",3,3,title=(r'ACCESS1.3 R3 April: mean rainfall'+sigma))
ACCESS_April_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/April/*.png",3,3,title=(r'ACCESS1.3 R3 April: mean rainfall anomalies'+sigma))
...
ACCESS_May = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/May/*.png",3,3,title=(r'ACCESS1.3 R3 May: mean rainfall'+sigma))
ACCESS_May_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/May/*.png",3,3,title=(r'ACCESS1.3 R3 May: mean rainfall anomalies'+sigma))
...
ACCESS_JJA = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/JJA/*.png",3,3,title=(r'ACCESS1.3 R3 JJA: mean rainfall'+sigma))
ACCESS_JJA_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/JJA/*.png",3,3,title=(r'ACCESS1.3 R3 JJA: mean rainfall anomalies'+sigma))
...
ACCESS_SON = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/SON/*.png",3,3,title=(r'ACCESS1.3 R3 SON: mean rainfall'+sigma))
ACCESS_SON_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/SON/*.png",3,3,title=(r'ACCESS1.3 R3 SON: mean rainfall anomalies'+sigma))
...
ACCESS_DJF = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/DJF/*.png",3,3,title=(r'ACCESS1.3 R3 DJF: mean rainfall'+sigma))
ACCESS_DJF_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/DJF/*.png",3,3,title=(r'ACCESS1.3 R3 DJF: mean rainfall anomalies'+sigma))
...
ACCESS_MAM = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/MAM/*.png",3,3,title=(r'ACCESS1.3 R3 MAM: mean rainfall'+sigma))
ACCESS_MAM_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/MAM/*.png",3,3,title=(r'ACCESS1.3 R3 MAM: mean rainfall anomalies'+sigma))
...
ACCESS_annual = multi("my_coding_routines/images/composite/"+num+"/rainfall/R3/Annual/*.png",3,3,title=(r'ACCESS1.3 R3 annual: mean rainfall'+sigma))
ACCESS_annual_Anom = multi("my_coding_routines/images/composite/"+num+"/rainfall_anomalies/R3/Annual/*.png",3,3,title=(r'ACCESS1.3 R3 annual: mean rainfall anomalies'+sigma))
